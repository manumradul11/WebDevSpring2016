...
module.exports = function (app, passport, LocalStrategy) {
    ...
    app.get("/api/user/getAllUsers", function (req, res) {
        LoginCtrl.getAllUsers(function (responce) {
            var admin ={users:responce};
            console.log(admin);
            res.send(admin);
        });
    });
    ...
    app.post("/api/user/updateUserByEmail", function (req, res) {
        ...
        LoginCtrl.updateUserByEmail(req.body.email,req.body.user, function (responce) {
            res.send(responce);
        });

    });

    app.delete("/api/user/deleteUserByEmail/email=:email", function (req, res) {

        LoginCtrl.deleteUserByEmail(req.params.email, function (responce) {
            res.send(responce);
        });
