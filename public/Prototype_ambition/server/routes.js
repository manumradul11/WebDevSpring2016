...
var DBManager = require(path.resolve("./public/Prototype_ambition/server/DAO/DatabaseManager.js"))();

var LoginCtrl = require(path.resolve('./public/Prototype_ambition/server/Controller/LoginCtrl.js'))();

var ProfileCtrl = require(path.resolve('./public/Prototype_ambition/server/Controller/ProfileCtrl.js'))();

var PostCtrl = require(path.resolve('./public/Prototype_ambition/server/Controller/PostCtrl.js'))();
...
module.exports = function (app, passport, LocalStrategy) {
    ...
    app.post("/api/user/post/create", function (req, res) {
        ...
        PostCtrl.post(email, post, function (response) {
            res.send(response);
        });
    });


    app.post("/api/user/post/getPosts", function (req, res) {
        var filter = req.body.data;
        PostCtrl.getPost(filter, function (response) {
            res.send(response);
        });
    });
